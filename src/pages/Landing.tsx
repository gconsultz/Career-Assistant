  ...
  const features = [
    {
      ...
      description: 'Track and evaluate your skills to identify areas for improvement.'
    },
    {
      icon: Target,
      title: 'Personalized Recommendations',
      description: 'Get career path suggestions tailored to your skills and interests.'
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Connect with industry professionals for guidance and advice.'
    }
  ];
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Discover your strengths, explore career opportunities, and get personalized guidance 
            to reach your professional goals with our AI-powered career assistant.
          </p>
          <div className="space-x-4">
            <Link to="/signup">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-lg font-semibold text-gray-900">Career Guidance</span>
            </div>
            <p className="text-gray-600">
